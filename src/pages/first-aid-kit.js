  ...
  return (
    <LandingPageLayout>
      ...
      <p>
        ...
        anything once you release this change you've been working on for a week
        already.
      </p>
      <p>
        <strong>Exhausted</strong>, because everything is such a tangled mess
        that you spend hours looking through 20 classes nesting and calling each
        other just to figure out what happens when you check or uncheck a
        checkbox.
      </p>
      <p>
      ...
      <p>
        ...
        making any changes, and months before you start feeling "at home" in the
        code. Finally, you are tasked to fix a bug on a different part of the
        codebase: the nightmare starts over again.
      </p>
      <h2 class="quote">
      ...
      <p>
        Your boss doesn't understand <em>why</em> it takes you longer and longer
        to finish tasks.
      </p>
      <p>
        <strong>You want to refactor. But would you risk the deadline?</strong>{" "}
      ...
      <p>
        ...
        its hemorrhage. Imagine how proud and relieved you'll feel as you put it
        back into a healthier shape.
      </p>
      <p>
      ...
      <p>
        Screencasts will show you the moves in action. You can get back to them
        when you're in doubt. Use the tools I crafted to assist you and automate
        parts of your refactoring.
      </p>
      <p>
        You'll learn how to concretely start turning a codebase into a testable,
      ...
      <p>
        Simply start with the next issue you have to work with, buy my kit, and
        you'll finally start making confident changes to your code in no time.
      </p>
    </LandingPageLayout>
  )
}
